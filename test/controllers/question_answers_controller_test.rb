...
class QuestionAnswersControllerTest < ActionController::TestCase
  ...
  test "should create question_answer" do
    assert_difference('QuestionAnswer.count') do
      post :create, question_answer: { answer: @question_answer.answer, image: @question_answer.image, question: @question_answer.question, tech: @question_answer.tech }
    end
  ...
  test "should update question_answer" do
    patch :update, id: @question_answer, question_answer: { answer: @question_answer.answer, image: @question_answer.image, question: @question_answer.question, tech: @question_answer.tech }
    assert_redirected_to question_answer_path(assigns(:question_answer))
  end
